...
import { BookOpen, Code, Coins, MessagesSquare, Wallet, ArrowRight, Github, Terminal, Globe } from 'lucide-react';
    ...
    overview: {
      ...
      content: (
        <div className="space-y-4">
          <p>IntentAI is a decentralized application that combines natural language processing with blockchain technology to enable users to interact with DeFi protocols through simple text commands. The project consists of three main components:</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="p-4 bg-black/20 rounded-xl border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-sm text-white/70">Natural language processing interface for user interactions</p>
            </div>
            ...
            <div className="p-4 bg-black/20 rounded-xl border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-sm text-white/70">Solidity contracts for DeFi protocol interactions</p>
            </div>
            ...
            <div className="p-4 bg-black/20 rounded-xl border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-sm text-white/70">Processing and routing of user intents</p>
            </div>
          </div>
        </div>
      )
          ...
          <div className="space-y-6">
            <div className="p-4 bg-black/20 rounded-xl border border-white/10">
              ...
              <ul className="list-disc list-inside space-y-2 text-white/70">
                ...
                <li>Documentation Page (docs.jsx)</li>
            ...
            <div className="p-4 bg-black/20 rounded-xl border border-white/10">
              ...
              <ul className="list-disc list-inside space-y-2 text-white/70">
                <li>CompoundIntents.sol - Main contract for Compound interactions</li>
                <li>CompoundETHManager.sol - ETH management logic</li>
      ...
      content: (
        <div className="space-y-6">
          <div className="p-4 bg-black/20 rounded-xl border border-white/10">
            ...
            <p className="mb-4 text-white/70">Main contract for processing user intents and interacting with Compound protocol.</p>
          ...
          <div className="p-4 bg-black/20 rounded-xl border border-white/10">
            ...
            <div className="space-y-2 text-white/70">
              <p>cETH Address (Mainnet): 0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5</p>
              <p>cETH Address (Goerli): 0x64078a6189Bf45f80091c6Ff2fCEe1B15Ac8dbde</p>
            </div>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-6">
          <div className="p-4 bg-black/20 rounded-xl border border-white/10">
            ...
            <p className="mb-4 text-white/70">Example commands for Compound protocol interactions:</p>
